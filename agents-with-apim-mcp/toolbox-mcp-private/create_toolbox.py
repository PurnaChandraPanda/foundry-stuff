...
def main() -> None:
    ...
    with (
        ...
        toolbox = project.toolboxes.create_version(
            ...
            description="Reviewed private APIM MCP tools for unattended agent use.",
            tools=[tool],
        )
    print(f"Created toolbox: {toolbox.name}, version: {toolbox.version}")
    print("Consumers follow the toolbox default version. Promote later versions explicitly after testing.")
