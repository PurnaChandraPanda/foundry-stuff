...
class CustomImageZoomInTool(BaseToolWithFileAccess):
    description = "Crop a specific region of an image and return the zoomed crop."
    parameters = {
        "type": "object",
        "properties": {
            "bbox_2d": {
    ...
    def call(self, params, **kwargs):
        ...
        label = params.get("label", "region")

        # crop logic here
        return [ContentItem(text=f"Zoomed region: {label} for bbox={bbox}")]
